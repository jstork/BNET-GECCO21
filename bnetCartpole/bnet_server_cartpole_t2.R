...
write.csv(logData, file = paste("resCartPole/bnet_cartpole_t2_",seed,".csv",sep=""))
save(allResDiscountedValue, file= paste("resCartPole/bnet_cartpole_t2_res_",Sys.getenv("PBS_ARRAYID"),".Rdata",sep=""))
