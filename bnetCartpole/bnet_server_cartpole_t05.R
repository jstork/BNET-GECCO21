...
write.csv(logData, file = paste("resCartPole/bnet_cartpole_t05_",seed,".csv",sep=""))
save(allResDiscountedValue, file= paste("resCartPole/bnet_cartpole_t05_res_",Sys.getenv("PBS_ARRAYID"),".Rdata",sep=""))
