...
while(length(fitness) <= 1000) {
  ...
  ##next Generation
  anns <- list(eliteFitAnn,bestSurrAnn)
...
write.csv(logData, file = paste("resCartPole2/bnet_cartpole_surrPMF_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole2/bnet_cartpole_surrPMF_res_",seed,".Rdata",sep=""))
write.csv(bestMethodCounter,file= paste("resCartPole2/bmc/bnet_cartpole_surrPMF_bm_",seed,".csv",sep=""))
write.csv(t,file= paste("resCartPole2/bmc/bnet_cartpole_surrPMF_bmt_",seed,".csv",sep=""))
