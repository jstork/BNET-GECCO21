...
write.csv(logData, file = paste("resCartPole2/bnet_cartpole_t1_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole2/bnet_cartpole_t1_res_",seed,".Rdata",sep=""))
write.csv(bestMethodCounter,file= paste("resCartPole2/bmc/bnet_cartpole_t1_bm_",seed,".csv",sep=""))
write.csv(t,file= paste("resCartPole2/bmc/bnet_cartpole_t1_bmt_",seed,".csv",sep=""))
