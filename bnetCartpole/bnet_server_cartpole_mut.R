...
while(length(fitness) <= 5000) {
  ...
  ##next Generation
  anns <- list(eliteFitAnn,mutateElite)
...
write.csv(logData, file = paste("resCartPole2/bnet_cartpole_mut_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole2/bnet_cartpole_mut_res_",seed,".Rdata",sep=""))
write.csv(bestMethodCounter,file= paste("resCartPole2/bmc/bnet_cartpole_mut_bm_",seed,".csv",sep=""))
write.csv(t,file= paste("resCartPole2/bmc/bnet_cartpole_mut_bmt_",seed,".csv",sep=""))
