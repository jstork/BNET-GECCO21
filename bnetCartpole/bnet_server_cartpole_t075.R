...
write.csv(logData, file = paste("resCartPole/bnet_cartpole_t075_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole/bnet_cartpole_t075_res_",Sys.getenv("PBS_ARRAYID"),".Rdata",sep=""))
