...
write.csv(logData, file = paste("resCartPole2/bnet_cartpole_new_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole2/bnet_cartpole_new_res_",seed,".Rdata",sep=""))
write.csv(bestMethodCounter,file= paste("resCartPole2/bmc/bnet_cartpole_new_bm_",seed,".csv",sep=""))
write.csv(t,file= paste("resCartPole2/bmc/bnet_cartpole_new_bmt_",seed,".csv",sep=""))
