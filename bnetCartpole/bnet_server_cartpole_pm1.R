...
for (i in 1:30) {
  ...
  crossEntropyAnns <- optimCrossEntropy(crossEntropyAnns,selectedExperienceInputs,selectedExperienceOutputs,selectedExperienceAdvantage,
                                        iterations=1000*trainingFactor,noElitist=2,numberChilds=20,mutationRate=0.01,plotFitness=FALSE)
...
write.csv(logData, file = paste("resCartPole2/bnet_cartpole_pm1_",seed,".csv",sep=""))
save(allResDiscounted, file= paste("resCartPole2/bnet_cartpole_pm1_res_",seed,".Rdata",sep=""))
write.csv(bestMethodCounter,file= paste("resCartPole2/bmc/bnet_cartpole_pm1_bm_",seed,".csv",sep=""))
write.csv(t,file= paste("resCartPole2/bmc/bnet_cartpole_pm1_bmt_",seed,".csv",sep=""))
